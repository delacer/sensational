    ...
    <main className="contact-container">
      ...
      <section className="contact-grid">
        ...
        <div className="contact-info">
          ...
          <ul>
            <li><FaMapMarkerAlt className="icon" /> 50 Wheeltree Way, Delft, Cape Town</li>
            <li><FaPhoneAlt className="icon" /> <a href="tel:+27613292763">+27 61 329 2763</a></li>
            <li><FaEnvelope className="icon" /> <a href="mailto:stevepeey@gmail.com">stevepeey@gmail.com</a></li>
            <li><FaWhatsapp className="icon" /> <a href="https://wa.me/27613292763" target="_blank" rel="noopener noreferrer">Chat on WhatsApp</a></li>
          </ul>
        </div>
        ...
        <div className="contact-form">
          ...
          <form ref={formRef} onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              <label htmlFor="service"><FaClipboardList className="icon" /> Service Type</label>
            ...
            <div className="form-group">
              <label htmlFor="message"><FaEnvelope className="icon" /> Message</label>
