...
const categories = [ "All", "Baby Shower", "Birthday Bash", "Marriage Ceremonies", "Anniversary", "Picnic", "Engagement", "Graduation", "Kindness", "Friends" ];
...
const EventCard = ({ image, alt, title, description, link, linkText, onImageClick }) => (
  <div className="event-card">
    <div className="event-image-wrapper" onClick={() => onImageClick(image)}>
      <img src={image} alt={alt} className="event-image" loading="lazy" />
    </div>
...
const Events = () => {
  ...
  return (
    <main className="events-container">
      ...
      <section className="events-grid" aria-label="Event listings">
